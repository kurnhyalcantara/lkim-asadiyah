...
@customElement('article-content-page')
export class ArticleContentPage extends ReduxMixin(PolymerElement) {
  ...
  @property({ type: Array })
  private suggestedPosts: Article[] = [];
  ...
  _postDataObserver(postId: string, posts: ArticleState) {
